    ...
    return (
        <Grid  className={classes.popularGrid} container>
            <Grid sm={6} xs={12} className={classes.styleOne}>
                <Button variant="outlined" className={classes.btnLook} onClick={() => history.push('/shop/earbus')}>
            ...
            <Button variant="outlined" className={classes.btnLook} onClick={() => history.push('/shop/weired-earbus')}>
                    <Typography variant="subtitle1">Buy This Look.</Typography>
                </Button>
           </Grid>
           <Grid item sm={12} xs={12} className={classes.styleThree}>
           <Button variant="outlined" className={classes.btnLook} onClick={() => history.push('/shop/headphones')}>
                    <Typography variant="subtitle1">Buy This Look.</Typography>
                </Button>
           </Grid>
            </Grid>
